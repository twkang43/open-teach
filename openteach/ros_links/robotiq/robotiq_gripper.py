...
Codes from: https://sdurobotics.gitlab.io/ur_rtde/_static/robotiq_gripper.py
"""
...
class RobotiqGripper:
    ...
    def get_min_speed(self) -> int:
        """Returns the minimum speed the gripper can be commanded to."""
        return self._min_speed
    
    def get_max_speed(self) -> int:
        """Returns the maximum speed the gripper can be commanded to."""
        return self._max_speed
    
    def get_min_force(self) -> int:
        """Returns the minimum force the gripper can be commanded to."""
        return self._min_force
    
    def get_max_force(self) -> int:
        """Returns the maximum force the gripper can be commanded to."""
